...
inventory = {
    'group_four': {
        'hosts': (
            (
                [f'group_four_host_0{i}' for i in range(1, 6)]
                + [f'group_four_and_five_host_0{i}' for i in range(1, 6)]
            )
            + [f'group_four_five_and_six_host_0{i}' for i in range(1, 6)]
        ),
    ...
    'group_five': {
        'hosts': (
            (
                (
                    [f'group_five_host_0{i}' for i in range(1, 6)]
                    + [f'group_four_and_five_host_0{i}' for i in range(1, 6)]
                )
                + [f'group_five_and_six_host_0{i}' for i in range(1, 6)]
            )
            + [f'group_four_five_and_six_host_0{i}' for i in range(1, 6)]
        ),
    ...
    'group_six': {
        'hosts': (
            (
                [f'group_six_host_0{i}' for i in range(1, 6)]
                + [f'group_five_and_six_host_0{i}' for i in range(1, 6)]
            )
            + [f'group_four_five_and_six_host_0{i}' for i in range(1, 6)]
        ),
    ...
    'ungrouped': {
        'hosts': [
            f"ungrouped_host_{f'0{i}' if len(str(i)) == 1 else i}"
            for i in range(6, 11)
        ]
    },
    '_meta': {
