...
inventory = {
    'group_one': {
        'hosts': (
            (
                [f'group_one_host_0{i}' for i in range(1, 6)]
                + [f'group_one_and_two_host_0{i}' for i in range(1, 6)]
            )
            + [f'group_one_two_and_three_host_0{i}' for i in range(1, 6)]
        ),
        'vars': {
    ...
    'group_two': {
        'hosts': (
            (
                (
                    [f'group_two_host_0{i}' for i in range(1, 6)]
                    + [f'group_one_and_two_host_0{i}' for i in range(1, 6)]
                )
                + [f'group_two_and_three_host_0{i}' for i in range(1, 6)]
            )
            + [f'group_one_two_and_three_host_0{i}' for i in range(1, 6)]
        ),
    ...
    'group_three': {
        'hosts': (
            (
                [f'group_three_host_0{i}' for i in range(1, 6)]
                + [f'group_two_and_three_host_0{i}' for i in range(1, 6)]
            )
            + [f'group_one_two_and_three_host_0{i}' for i in range(1, 6)]
        ),
    ...
    'ungrouped': {'hosts': [f'ungrouped_host_0{i}' for i in range(1, 6)]},
}


hostvars = {'group_one_host_01': {'group_one_host_01_has_this_var': True},
